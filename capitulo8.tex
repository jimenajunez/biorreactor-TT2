...
\midrule
Radio interno del tanque (\textit{riser}) & $R_r$ & 136~mm \\
...
Capacidad volumétrica total del tanque & $V$ & 45~L \\
\bottomrule
\end{tabularx}
\end{table}
...
tanque, con un espesor de pared de 3.5~mm. El AISI 304 ofrece excelente resistencia a
...
son adecuados para la aplicaci\'on. Las tolerancias dimensionales de los agujeros pasados y roscas empleadas en el ensamblaje se especifican en el Anexo~\ref{ap:manufactura}.
